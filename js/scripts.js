$(document).ready(function () {
    ...
    for (var i = 0; i < share_bar.length; i++) {
        var html = '<iframe allowtransparency="true" frameborder="0" scrolling="no"' +
            'src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + '&amp;text=' + encodeURIComponent(document.title) + '&amp;via=AlexLablaiks&amp;hashtags=ReaganAndAlexWedding&amp;count=horizontal"' +
	...
	var submitRsvpForm = function (successCallback) {
        ...
        if (MD5($('#wedding_code').val()) !== '3fc9cee0ab3a704dadcf4d428b71a7d7') {
            ...
            $.post('https://script.google.com/macros/s/AKfycbwJ977794ODnv4f4hgexwjKq2lA01vGW5otPAzER4c8kXf9UzGMJWnysS1JeHT5xN-I/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 41.990131449175074, lng: -87.65576394582493};
